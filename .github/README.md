...
```bash
sudo pacman -S networkmanager zsh pulseaudio blueman qt6-wayland qt5-wayland nerd-fonts hyprpaper hyprland waybar rofi-wayland wofi firefox kitty dolphin curl nvim gnome-clocks rsync jq
```
